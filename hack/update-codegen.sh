...
kube::codegen::gen_client \
  ...
  --output-pkg "github.com/openshift-pipelines/tekton-armadas/pkg/client" \
  --with-watch \
...
${KNATIVE_CODEGEN_PKG}/hack/generate-knative.sh "injection" \
  github.com/openshift-pipelines/tekton-armadas/pkg/client github.com/openshift-pipelines/tekton-armadas/pkg/apis \
  "armada:v1alpha1" \
